          ...
          <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
              ...
              <ul class="nav  navbar-nav justify-content-center flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                <HashLink to={"/#Whoweare"} class="nav-link">About us</HashLink>
                </li>
                <li class="nav-item">
                  <HashLink to={"/#Whatwedo"} class="nav-link">Services</HashLink>
                </li>
                <li class="nav-item">
                  <Link to="/case" class="nav-link " aria-current="page" >Case studies</Link>
                </li>
                <li class="nav-item">
                  <HashLink to={"/#contactUs"} class="nav-link">Contact us</HashLink>
                </li>
              </ul>
              <Link to="/login"><img class="login-icon " src={loginicon} /></Link>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll nav-underline  justify-content-center flex-grow-1 pe-3">
              ...
              <li class="nav-item">
              <HashLink to={"/#Whoweare"} class="nav-link" onClick={AboutActive} className={AboutIsActive? "active" : ""}>About us</HashLink>
              </li>
              <li class="nav-item">
              <HashLink to={"/#Whatwedo"} class="nav-link" onClick={ServicesActive} className={ServicesIsActive? "active" : ""}>Services</HashLink>
              </li>
              <li class="nav-item">
              <NavLink to="/case" class="nav-link " aria-current="page" >Case studies</NavLink>
              </li>
              <li class="nav-item">
              <HashLink to={"/#contactUs"} class="nav-link" onClick={ContactActive} className={ContactIsActive? "active" : ""}>Contact us</HashLink>
              </li>
            </ul>

            <form class="d-flex" role="search">
              <button onClick={goToLogin} class="btn nav-btnlg" type="submit">Login</button>
            </form>
          </div>
        </div>
      </nav>
